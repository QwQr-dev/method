...
LoadKeyboardLayoutA = CALLBACK(HKL, LPCSTR, UINT)
LoadKeyboardLayoutW = CALLBACK(HKL, LPCWSTR, UINT)
ActivateKeyboardLayout = CALLBACK(HKL, HKL, UINT)
ToUnicodeEx = CALLBACK(INT, UINT, UINT, BYTE, LPWSTR, INT, UINT, HKL)
UnloadKeyboardLayout = CALLBACK(BOOL, HKL)
GetKeyboardLayoutNameA = CALLBACK(BOOL, LPSTR)
GetKeyboardLayoutNameW = CALLBACK(BOOL, LPWSTR)
GetKeyboardLayoutList = CALLBACK(INT, INT, HKL)
GetKeyboardLayout = CALLBACK(HKL, DWORD)
...
def MessageBoxIndirect(hwndOwner: int = HWND(), 
    ...
    res = MessageBoxIndirect(byref(mbp)) 
...
def FindWindow(lpClassName: str | bytes, 
