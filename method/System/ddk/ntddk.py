...
def NtTerminateProcess(ProcessHandle: int, ExitStatus: int, errcheck: bool = True) -> None:
...
def ZwTerminateProcess(hProcess: int, uExitCode: int, errcheck: bool = True) -> None:
